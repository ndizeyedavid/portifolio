...
export const DATA = {
  ...
  summary:
    "I build fun stuff, break it, fix it, and repeat all while chasing Code, a Sleep, and chaos - that's the grind. I'm a chill Rwandan brogrammer leveling up in full-stack dev, always building side quests like IoT projects, school platforms, and health apps. I don't just write code, I drop combos in games too",
  avatarUrl: "/me.png",
  skills: [
    "Next.js",
    "React Native",
